...
CREATE TABLE api_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE api_stage_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE api_scope_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE api_reviewer_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE project_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE project_member_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE project_api_key_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE project_usage_plan_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE project_usage_plan_key_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE project_cognito_client_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE access_request_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE subscription_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE usage_plan_stage_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE client_scope_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE provisioning_operation_events (LIKE hub_user_events INCLUDING ALL);
CREATE TABLE provisioning_step_events (LIKE hub_user_events INCLUDING ALL);
