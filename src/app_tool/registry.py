...
TOOL_SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        name="generate_e2e_factor_yaml",
        command="uv run python -m tools.generate_e2e_factor_yaml",
        category="docs",
        summary="E2E flow と API contract/samples/unit-test factors から E2E 要因YAMLを生成する。",
        inputs=(
            "docs/spec/50.e2e/*/flow.manual.yaml",
            "src/app/apis/*/*/router.py",
            "src/app/apis/*/*/contract.py",
    ...
    ToolSpec(
        name="generate_e2e_case_list",
        command="uv run python -m tools.generate_e2e_case_list",
        category="docs",
        summary="E2E要因YAMLから枝刈り済みケース一覧を生成する。",
        inputs=(
            "docs/spec/50.e2e/*/factors/*.gen.yaml",
            "docs/spec/50.e2e/*/overrides.manual.yaml",
        ),
        outputs=("docs/spec/50.e2e/*/case-list_gen.md", "docs/spec/50.e2e/*/pruned-cases_gen.csv"),
        depends_on=("generate_e2e_factor_yaml",),
        check_supported=True,
        safe_to_run_in_ci=True,
        examples=(
            "uv run app-docs generate",
    ...
    ToolSpec(
        name="generate_e2e_scenarios",
        command="uv run python -m tools.generate_e2e_scenarios",
        category="docs",
        summary="E2Eケース一覧とstep templateからテストケースごとのシナリオMarkdownを生成する。",
        inputs=(
            "docs/spec/50.e2e/*/case-list_gen.md",
            "docs/spec/50.e2e/*/templates/**/*.manual.yaml",
        ),
        outputs=("docs/spec/50.e2e/*/cases/*.gen.md",),
        depends_on=("generate_e2e_case_list",),
        check_supported=True,
        safe_to_run_in_ci=True,
        examples=(
            "uv run app-docs generate",
            "uv run python -m tools.generate_e2e_scenarios --check",
        ),
    ),
    ToolSpec(
    ...
    ToolSpec(
        name="check_e2e_specs",
        command="uv run python -m tools.check_e2e_specs",
        category="lint",
        summary="E2E flow/factor/case/scenario 仕様の参照整合を検査する。",
        inputs=("docs/spec/50.e2e/*",),
        outputs=("stdout",),
        depends_on=("generate_e2e_scenarios",),
        check_supported=True,
        safe_to_run_in_ci=True,
        examples=("uv run app-archlint all", "uv run python -m tools.check_e2e_specs"),
    ),
)
