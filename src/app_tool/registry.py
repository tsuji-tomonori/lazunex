...
TOOL_SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        inputs=(
            ...
            "docs/spec/50.e2e/*/data/**/*.manual.yaml",
            "docs/spec/50.e2e/*/generated/*.manual.yaml",
    ...
    ToolSpec(
        ...
        inputs=(
            ...
            "docs/spec/50.e2e/*/bindings/*.manual.yaml",
            "docs/spec/50.e2e/*/rules/renderer.manual.yaml",
