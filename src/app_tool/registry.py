...
TOOL_SPECS: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        category="docs",
        summary="E2E component YAMLから枝刈り済みケース一覧を生成する。",
        inputs=(
            "docs/spec/50.e2e/*/targets/**/*.manual.yaml",
            "docs/spec/50.e2e/*/components/**/*.manual.yaml",
            "docs/spec/50.e2e/*/rules/*.manual.yaml",
        ),
    ...
    ToolSpec(
        ...
        inputs=(
            ...
            "docs/spec/50.e2e/*/targets/**/*.manual.yaml",
            "docs/spec/50.e2e/*/components/**/*.manual.yaml",
            "docs/spec/50.e2e/*/steps/management_api/*.manual.yaml",
            "docs/spec/50.e2e/*/steps/runtime_api/*.manual.yaml",
