...
async def test_tc001_list_projects_router_matches_unit_test_gen(
    ...
    monkeypatch.setattr(
        "app.apis.projects.list_projects.functions.operational_log_context_model",
...
@pytest.mark.anyio
async def test_tc004_list_projects_router_matches_unit_test_gen(
    router_db_harness: Any,
    router_auth_headers: Any,
    monkeypatch: Any,
    capsys: Any,
...
@pytest.mark.anyio
async def test_tc005_list_projects_router_matches_unit_test_gen(
    router_db_harness: Any,
    router_auth_headers: Any,
    monkeypatch: Any,
    capsys: Any,
