...
| router | `src/app/apis/apis/get_api/router.py` |
| messages | 2 |
...
| 実装参照 | src/app/apis/apis/get_api/functions.py<br>wrapper: src/app/apis/apis/get_api/functions.py (ops_logger.warning) |
...
| 実装参照 | src/app/apis/apis/get_api/functions.py<br>wrapper: src/app/apis/apis/get_api/functions.py (ops_logger.error) |
