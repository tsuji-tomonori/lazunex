...
| カラム | 型 | NULL許可 | キー | 説明 |
| :--- | :--- | :--- | :--- | :--- |
| `client_url_id` | `CHAR(36)` | NO | PK | App Client URL ID。 |
| `project_cognito_client_id` | `CHAR(36)` | NO | FK -> project_cognito_clients(project_cognito_client_id) | 紐づくProject App Client ID。 |
| `url_type` | `VARCHAR(20)` | NO |  | URL種別。CALLBACKまたはLOGOUT。 |
| `url` | `VARCHAR(500)` | NO |  | callback URLまたはlogout URL。 |
