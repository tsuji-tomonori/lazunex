...
| カラム | 型 | NULL許可 | キー | 説明 |
| :--- | :--- | :--- | :--- | :--- |
| `operation_step_id` | `CHAR(36)` | NO | PK | AWS反映step ID。 |
| `operation_id` | `CHAR(36)` | NO | FK -> provisioning_operations(operation_id) | 親operation ID。 |
...
| `started_at` | `DATETIME(6)` | YES |  | step開始日時。 |
| `finished_at` | `DATETIME(6)` | YES |  | step終了日時。 |
